  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
      <SurfaceCard className="space-y-5">
        <div>
          <h3 className="text-2xl">Generate a tailored website direction</h3>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <SurfaceCard className="overflow-hidden p-0">
            <div className={`p-5 md:p-7 ${preview ? `bg-gradient-to-br ${styleClassMap[selectedStyle]}` : "bg-[#163A70]"}`}>
              <div className="rounded-[26px] bg-white p-4 shadow-[0_20px_50px_rgba(22,58,112,0.16)] md:p-6">
                ...
                {preview ? (
                  <div className="mt-5 space-y-5">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <button type="button" className="rounded-full bg-[#2F6BFF] px-5 py-3 text-sm font-medium text-white">
                        {preview.primaryCta}
                      </button>
