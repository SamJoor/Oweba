...
export function ProcessSectionArt() {
  return (
    <section className="section-divider py-16 md:py-24">
      <Container className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
        ...
        />
        <div className="space-y-5 border-l border-[#163A70]/10 pl-6">
          {processSteps.map((step, index) => (
            <div
              key={step.title}
              className="relative grid gap-5 rounded-[28px] border border-white/55 bg-white/70 p-6 shadow-[0_16px_40px_rgba(22,58,112,0.08)] md:grid-cols-[80px_1fr]"
            >
              <span className="absolute -left-[2.1rem] top-9 h-3 w-3 rounded-full bg-[#2F6BFF]" />
